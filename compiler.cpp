    ...
    ui(new Ui::Compiler)
{
    ui->setupUi(this);
    aboutdata();
    if(!QFile::exists(QDir::currentPath()+"/profiles/gcc.opt") && !QFile::exists(QDir::currentPath()+"/profiles/deb.opt")){
    ...
    if(QFile::exists(QDir::currentPath() + "/profiles/gui.opt")){
        ...
        ui->warnings_select->setStyleSheet(buttoncheckboxcolor);
        ui->warnings_selected->setStyleSheet(buttoncheckboxcolor);
        ui->gcc_verbose_enable->setStyleSheet(buttoncheckboxcolor);
        ui->gcc_debug_enable->setStyleSheet(buttoncheckboxcolor);
        ui->gcc_all_warnings_enable->setStyleSheet(buttoncheckboxcolor);
        ui->gcc_extra_warnings_enable->setStyleSheet(buttoncheckboxcolor);
        ui->deb_dpkg_debug_enable->setStyleSheet(buttoncheckboxcolor);
        ui->deb_dpkg_verbose_enable->setStyleSheet(buttoncheckboxcolor);
        ui->supportlist->setStyleSheet(listcolor);
        ui->double_combo->setStyleSheet(listcolor);
        ui->compiler_mode->setStyleSheet(listcolor);
        ui->debdpkg_about_data->setStyleSheet(textlinecolor);
        ui->gcc_about_data->setStyleSheet(textlinecolor);

        ui->on_save_compiler_button->setStyleSheet(buttoncheckboxcolor);
        ui->cancelButton->setStyleSheet(buttoncheckboxcolor);}
    this->setWindowTitle(tr("Fordító beállításai"));
    //
}
